class PaymentDecorator < ApplicationDecorator
  ...
  def DT_actions
    header = '<div class="d-flex gap-2">'.html_safe
      show = h.link_to '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-credit-card-fill" viewBox="0 0 16 16">
    ...
    h.safe_join([header, show, delete, footer], '')
  end
end
